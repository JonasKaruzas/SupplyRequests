...
export default class SupplyRequests extends React.Component<ISupplyRequestsProps, {}> {
  
  
  public render(): React.ReactElement<ISupplyRequestsProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
...
// const list = [1,2,3]
    ...
    const [list, setList] = React.useState<string[]>(['1', '2'])
