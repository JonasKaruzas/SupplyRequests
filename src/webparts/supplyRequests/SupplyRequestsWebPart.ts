...
export default class SupplyRequestsWebPart extends BaseClientSideWebPart<ISupplyRequestsWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ISupplyRequestsProps> = React.createElement(
      SupplyRequests,
      {
